...
public class UserService {
	...
	public static String login(String phonenumber, String password) throws IOException {
		...
		try {
			...
			String sql = "select * from " + DBManager.TABLE_USERINFO + " where phonenumber='" + phonenumber
	...
	public static String register(String phonenumber, String password,String userName) throws IOException {
		//String userPhone = "";
		try {
			Connection connect = null;
			try {
			...
			String sqlQuery = "select * from " + DBManager.TABLE_USERINFO + " where phonenumber='" + phonenumber + "'";
			...
			if(result.next()){ // 已存在
				...
				String sqlInsertPass = "insert into " + DBManager.TABLE_USERINFO + "(phonenumber,password,username) values('"+phonenumber+"','"+password+"','"+userName+"')";
